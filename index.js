			...
			tels = body.slice(6)
               ...
               if (data.error) return reply(data.error)
				...
				case 'zerotwo':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Oiie@${nomor.split("@s.whatsapp.net")[0]}\nVou dar algumas informações sobre mim,se quiser ver direto e mais rápido \ndigite !botInfo \nNome:Zero Two \nNumero:http://Wa.me/+558896904592 \nData de criação:30/11/2020 \nHora:19:28 \nColaboradores(Os Pika) \nMerlin \nBiel \nSatã/Meliodas'})
					break
				case 'memeindo':
					memein = await kagApi.memeindo()
