			...
			tels = body.slice(6)
               ...
               if (data.error) return reply(data.error)
				...
				case 'dono':
					...
					buffer = await getBuffer(`https://i.imgur.com/2QNMvji_d.webp?maxwidth=640&shape=thumb&fidelity=medium`)
