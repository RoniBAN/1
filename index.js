			...
			tels = body.slice(6)
               ...
               if (data.error) return reply(data.error)
				...
				case 'dono':
					...
					buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT8_jDwSV2YH4cvMAukEmzZtybupC2WEeDa9g&usqp=CAU`)
				...
				case 'zerotwo':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Oiie @${num.split('@')[0]}\nVou dar algumas informações sobre mim\nNome:Zero Two \nNumero:http://Wa.me/+558896904592 \nData de criação:30/11/2020'})
					break
				case 'canal':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT4MxB2M6mu_KY-awP3N5PdX0A_YHvpMfXqcw&usqp=CAU`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Se inscreva e deixe o like pra dar uma moral \nCanal: https://youtu.be/5yBC7hhO8bY'})
					break
				case 'memeindo':
					memein = await kagApi.memeindo()
