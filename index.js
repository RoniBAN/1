			...
			tels = body.slice(6)
               ...
               if (data.error) return reply(data.error)
				...
				case 'hentai':
					...
					buffer = await getBuffer(`https://www.sohentaidobom.com/2015/03/imagens-aleatorias-01-jpg.html?m=1&zx=d362ce874ab8325a`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Zé punhetinha é foda\n Só vão usar esse comando'})
					break
				case 'hentai2':
					memein = await kagApi.memeindo()
